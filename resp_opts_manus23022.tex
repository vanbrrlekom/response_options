...
\hypertarget{overview-of-planned-studies}{%
\subsection{Overview of planned studies}\label{overview-of-planned-studies}}

Based on the problems with binary measurement, we planned two studies to demonstrate alternatives to binary measurment of gender categorization and to investigate how such alternative impact participants results. The purpose of bothg experiment was to answer the following three research quetions.
