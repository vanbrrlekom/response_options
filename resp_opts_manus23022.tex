...
Rather, most becomes evident that the vast majority of studies either explicitly or implicitly communicate to participants that gender consists of the binary categories of woman and man. Most often gender categorization is measured with a forced-choice task, where participants are presented with a face and forced to indicate either ``female'' or ``male'' (see, for example, Cloutier et al., 2005; Campanella et al., 2001; Webster et al., 2004; Zhao \& Bentin, 2008). A slightly different approach asks participants to rate the faces on a scale of gender as a quality, with ``feminine'' and ``masculine'' often serving as endpoints on a single scale (e.g., D'Ascenzo et al., 2015; others). Despite some variations, the literature on gender categorization overwhelmingly presents gender as a binary.
