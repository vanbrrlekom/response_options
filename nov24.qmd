...
*I have collapsed the research of self and other categorization. Why did I do this? Basically because I found that the paper was getting quite repetitious* Over the years, a number of studies have investigated gender categorization using response formats that challenge gender hierarchies. One solution is to conceptualise femininity and masculinity as independent entities. Unlike one-dimensional treatments of gender, such a two-dimensional approach does not imply that femininity and masculinity are opposites and that an increase in one necessarily entails a decrease in the other. One of the earliest examples of scales to use such an approach was the Bem Sex Role Inventory (BSRI), a questionnaire scale which aimed to measure gender as a psychological trait [@bemMeasurmentPsychologicalAndrogyny1974]. When this scale was used, some participants exhibited clear femininity or masculinity but many scored as "androgynous" (high femininity, high masculinity) and "neutral" (low femininity, low masculinity), destabilising binary notions of gender [@libenUnderstandingUnderminingDevelopment2017]. Such a treatment of gender has been recommended both for participants categorizing their own gender (saperstein) used in face categorization research (Wittlin, 2018).
