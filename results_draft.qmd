...
I've divided this into two experiments: experiment 1 which includes the binary options, multiple categories and the freetext options. Below I just show the raw distributions of scores in each condition
